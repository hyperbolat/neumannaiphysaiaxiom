...
NAMES_MAP = {
    ...
    # Ранее пропущенные переменные (показывались "сырыми" в отчётах —
    # найдено при разборе жалобы на плохие объяснения explainer.py)
    "a_work": "Работа", "alpha": "Угол наклона", "ek": "Кинетическая энергия",
    "ep": "Потенциальная энергия", "eps": "Угловое ускорение", "h": "Высота",
    "i_inert": "Момент инерции", "k": "Коэффициент жёсткости", "l_am": "Момент импульса",
    "m_torque": "Момент силы", "omega": "Угловая скорость", "p": "Импульс",
    "p_pow": "Мощность", "r_rad": "Радиус", "t_tension": "Натяжение нити",
    "tau": "Характерное время", "u": "Скорость после столкновения",
    "v1": "Скорость тела 1", "v2": "Скорость тела 2", "x": "Смещение"
}
